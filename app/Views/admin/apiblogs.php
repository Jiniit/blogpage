        ...
        <div class="card">
          <div class="table-responsive">
            <table class="table mb-0 align-middle">
              ...
              <tbody>
                <tr>
                  <?php foreach ($api_blogs as $row) : ?>
                <tr>
                  <td><?= $row['id'] ?></td>
                  <td style="width:300px"><?= $row['title'] ?></td>
                  <td style="width:300px"><?= $row['body'] ?></td>
                  <td>
                    <a class="btn btn-success" href="<?= base_url('editApi/' . $row['id']) ?>">Edit</a>
                    <a class="btn btn-danger" href="<?= base_url('deleteApi/' . $row['id']) ?>" onclick="return confirmDelete();">Delete</a>
                    <script>

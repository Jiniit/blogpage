            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?php echo base_url('/updateCategory'); ?> " method="post">
                                    <label for="title1" class="form-label">Category ID</label>
                                    <input type="text" readonly name="category_id" value="<?= $category['category_id'] ?>" class="form-control" id="bcid">
                            </div>
                            <div class="mb-3">
                                <label for="title1" class="form-label">Category Name</label>
                                <input type="text" name="category_name" value="<?= $category['category_name'] ?>" class="form-control" id="baid">
                            </div>
                            <div class="mb-3">
                                <label for="description1" class="form-label">Category Description</label>
                                <input type="text" name="category_description" value="<?= $category['category_description'] ?>" class="form-control" id="bdescription1">
                            </div>
                            <div class="mb-3">
